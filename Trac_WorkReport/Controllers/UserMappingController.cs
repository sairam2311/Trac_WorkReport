...
namespace Trac_WorkReport.Controllers
{
    public class UserMappingController : Controller
    {
        ...
        public UserMappingController(Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> userManager, Microsoft.AspNetCore.Identity.RoleManager<ApplicationRole> roleManager, ApplicationDbContext context)
        {
